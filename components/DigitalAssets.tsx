      ...
      {view === 'form' && (
        <div className="bg-white p-6 rounded shadow-sm border border-gray-200 max-w-2xl">
          <h3 className="text-lg font-medium text-gray-700 mb-6 border-b pb-2">
            {formData.id ? 'Editar' : 'Cadastrar'} Mídia Digital
          </h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            {searchResults.map((book: any, idx) => {
              ...
              return (
                <div
                  key={book.id + idx}
                  className="border rounded p-4 flex gap-4 hover:shadow-md transition-shadow"
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <h4 className="font-bold text-gray-800 text-sm truncate" title={info.title}>
                      {info.title}
                    </h4>
