        ...
        <div className="space-y-4 max-w-2xl">
          ...
          <div className="pt-4 border-t">
            <label className="block text-sm font-medium text-gray-700 mb-3">
              Marque as colunas para exibir na tabela de Acervos
            </label>
            <div className="grid grid-cols-2 gap-2">
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={form.bookColumns.format}
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={form.bookColumns.isbn}
                  onChange={() => toggleColumn('isbn')}
                  className="rounded text-primary focus:ring-primary bg-white"
                />
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={form.bookColumns.author}
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={form.bookColumns.publisher}
                  onChange={() => toggleColumn('publisher')}
                  className="rounded text-primary focus:ring-primary bg-white"
                />
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={form.bookColumns.quantity}
              ...
              <label className="flex items-center space-x-2">
                <input
                  type="checkbox"
                  checked={form.bookColumns.synopsis}
                  onChange={() => toggleColumn('synopsis')}
                  className="rounded text-primary focus:ring-primary bg-white"
                />
