...
import { Edit, Trash2, Tag, Book as BookIcon, X, Printer, Upload } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 animate-fade-in relative">
            ...
            <table className="w-full text-sm text-left text-gray-600">
              <thead className="text-xs text-gray-700 uppercase bg-gray-100">
                <tr>
                  ...
                  {settings.bookColumns.knowledgeArea && (
      ...
      {view === 'formats' && (
        <div className="bg-white p-6 rounded shadow-sm border border-gray-200">
          <h3 className="text-lg font-medium text-gray-700 mb-6 border-b pb-2">
            Inserir Novo Formato de Acervo
          </h3>
          <div className="flex gap-2 mb-8 items-end">
            ...
            <button
              ...
              className="bg-secondary text-white px-4 py-2 rounded hover:bg-blue-600 h-10 mb-[1px]"
            >
              Inserir
            </button>
            <button
              onClick={() => setFormatName('')}
              className="bg-gray-200 text-gray-600 px-4 py-2 rounded hover:bg-gray-300 h-10 mb-[1px]"
            >
              Cancelar
            </button>
          </div>
              ...
              {formats.map((fmt, idx) => (
                <tr key={fmt.id} className="bg-white hover:bg-gray-50">
                  ...
                  <td className="px-4 py-2 border text-right">
                    <button
                      onClick={() => handleFormatDelete(fmt.id)}
      ...
      {view === 'form' && (
        <div className="bg-white p-6 rounded shadow-sm border border-gray-200">
          <h3 className="text-lg font-medium text-gray-700 mb-6 border-b pb-2">
            {formData.id ? 'Editar' : 'Inserir Novo'} Cadastro
          </h3>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-400 mt-1">
                    Resultado da pesquisa preenche os campos automaticamente.
                  </p>
                </div>
              </div>
          ...
          <div className="mt-6 flex justify-end gap-2 border-t pt-4">
            <button
              onClick={() => setView('list')}
              className="px-4 py-2 bg-gray-200 border rounded text-gray-600 hover:bg-gray-300"
            >
              Retornar
            </button>
            <button
              onClick={() => setView('list')}
              className="px-4 py-2 border rounded text-gray-600 bg-white hover:bg-gray-50"
            >
              Cancelar
            </button>
            <button
              onClick={handleSave}
              className="px-6 py-2 bg-secondary text-white rounded hover:bg-blue-600"
            >
              Submit
            </button>
          </div>
          ...
          <div className="bg-white rounded-lg p-6 w-[800px] h-[80vh] shadow-xl animate-fade-in flex flex-col">
            <div className="flex justify-between items-center mb-4 border-b pb-2">
              <h3 className="text-lg font-medium text-gray-700 flex items-center">
                <Tag className="mr-2" /> Etiquetas de Lombada
              </h3>
              <button
            ...
            <div className="flex-1 overflow-y-auto bg-gray-100 p-4 border rounded">
              <div className="grid grid-cols-4 gap-4 print:grid-cols-4">
                {books.map(book => (
                  <div
                    key={book.id}
                    className="bg-white border-2 border-dashed border-gray-300 p-2 text-center text-xs flex flex-col items-center justify-center h-24 w-full shadow-sm"
                  >
                    <span className="font-bold text-[10px] uppercase truncate w-full">
                      {book.category.substring(0, 10)}
                    </span>
                    <span className="text-lg font-bold my-1">{book.shelf}</span>
                    <span className="text-[9px] uppercase truncate w-full">
            ...
            <div className="mt-4 flex justify-end">
              <button
                ...
                className="bg-primary text-white px-4 py-2 rounded flex items-center hover:bg-primaryDark"
              >
