...
import { User, UserRole, Book, Loan, DigitalAsset, ClassSector, BookFormat, AppSettings } from './types';
...
const App: React.FC = () => {
  ...
  // Data State (explicit generics to avoid `never[]` inference for empty arrays)
      ...
      default:
        return (
            <div className="flex flex-col items-center justify-center h-full text-gray-400">
                ...
                <p>O módulo <strong>{currentPage}</strong> será implementado em breve.</p>
            </div>
        );
    }
  };
  ...
  return (
    <div className="flex min-h-screen bg-gray-100 relative">
      ...
      <div className={`w-full flex flex-col transition-all duration-300 ${isSidebarOpen ? '' : 'ml-0'} md:ml-64`}>
        <TopBar 
            settings={settings} 
            user={currentUser!} 
