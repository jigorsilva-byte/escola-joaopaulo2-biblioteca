...
const INITIAL_BOOKS: Book[] = [
  {
    id: '1',
    title: 'Novo Manual da Literatura',
    author: 'João',
    isbn: '123857484',
    category: 'Literatura',
    format: 'LIVRO',
    ...
    shelf: '8',
    shelfLocation: '3',
    coverUrl: 'https://picsum.photos/100/140',
    publisher: 'Editora A',
  },
  {
    id: '2',
    ...
    category: 'Clássico',
    format: 'LIVRO',
    knowledgeArea: 'Literatura Brasileira',
    year: '1899',
    quantity: 5,
    available: 5,
    shelf: 'A1',
...
const INITIAL_LOANS: Loan[] = [
  {
    ...
    bookId: '1',
    bookTitle: 'Novo Manual da Literatura',
    loanDate: '2023-10-25',
    dueDate: '2023-11-01',
    status: 'Atrasado',
  },
...
const INITIAL_ASSETS: DigitalAsset[] = [
  {
    id: '1',
    title: 'Dom Quixote - PDF',
    type: 'PDF',
    category: 'Clássico',
    url: '#',
    coverUrl: 'https://picsum.photos/100/140?random=10',
  },
  {
    id: '2',
    title: 'Audiobook: Harry Potter',
    type: 'Audiobook',
    category: 'Fantasia',
    url: '#',
    coverUrl: 'https://picsum.photos/100/140?random=11',
  },
];
  ...
  loans.forEach(loan => {
    if (loan.status === 'Emprestado' || loan.status === 'Atrasado') {
      ...
      const exists = notifications.some(
        n => n.message.includes(loan.bookTitle) && n.userId === loan.userId && n.date === today
      );
